...
#include "WorkingWithExpressionsAndBitWiseOperators.hpp"
#include <iostream>
#include <memory>
...
int main()
{
    ...
    // WorkingWithExpressionsAndBitWiseOperators Examples
    WorkingWithExpressionsAndBitWiseOperators exprBitwiseObj;
    exprBitwiseObj.demonstrateBitwiseOperations();
    exprBitwiseObj.demonstrateExpressions();
    exprBitwiseObj.demonstrateMoreBitwiseOperations();
    exprBitwiseObj.demonstrateBitSettingAndClearing();
    exprBitwiseObj.demonstrateBitParityCheck();
    exprBitwiseObj.demonstrateBitmaskCreation();
    exprBitwiseObj.demonstrateBitwiseInConditionals();
    exprBitwiseObj.demonstrateCombinedBitwiseOperations();
    exprBitwiseObj.demonstrateBitwiseWithEnums();
    exprBitwiseObj.demonstrateBitCounting();
    exprBitwiseObj.demonstrateBitMasking();
    exprBitwiseObj.demonstrateBitRotation();
    exprBitwiseObj.demonstrateBitFieldUsage();
